 ...
 */
class AlexaSiteInfoPageViewsPerDay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlexaSiteInfo_pageViewsPerDay';
    ...
    {
        $this->setIfExists('perUser', $data ?? [], null);
        $this->setIfExists('codeltaunty', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets perUser
     *
     * @param int|null $perUser perUser
     *
     * @return self
     */
    ...
    {
        if (is_null($perUser)) {
            throw new \InvalidArgumentException('non-nullable perUser cannot be null');
        }
     ...
     * Sets codeltaunty
     *
     * @param string|null $codeltaunty codeltaunty
     *
     * @return self
     */
    public function setCodeltaunty($codeltaunty)
    {
        if (is_null($codeltaunty)) {
            throw new \InvalidArgumentException('non-nullable codeltaunty cannot be null');
        }
