 ...
 */
class AlexaSiteInfoSiteData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlexaSiteInfo_siteData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('onlineSince', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets onlineSince
     *
     * @param string|null $onlineSince onlineSince
     *
     * @return self
     */
    public function setOnlineSince($onlineSince)
    {
        if (is_null($onlineSince)) {
            throw new \InvalidArgumentException('non-nullable onlineSince cannot be null');
        }
