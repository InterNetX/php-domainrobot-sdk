 ...
 */
class CertificateHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CertificateHistory';
    ...
    */
     ...
     * Sets serialNumber
     *
     * @param string|null $serialNumber The serialnumber of the certificate.
     *
     * @return self
     */
     ...
     * Sets revoked
     *
     * @param \DateTime|null $revoked The revoked date of the certificate.
     *
     * @return self
     */
