 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CertificateInstallCheckNotice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CertificateInstallCheckNotice';
     ...
     * Sets label
     *
     * @param string $label The label of the notice
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The value of the notice
     *
     * @return $this
     */
