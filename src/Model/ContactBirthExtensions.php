 ...
 */
class ContactBirthExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactBirthExtensions';
    ...
    */
     ...
     * Sets country
     *
     * @param string|null $country Birth country (ISO 3166 Country Code).
     *
     * @return self
     */
     ...
     * Sets day
     *
     * @param \DateTime|null $day Birthday (yyyy-MM-dd).
     *
     * @return self
     */
     ...
     * Sets postalCode
     *
     * @param string|null $postalCode Postal code of the birth place.
     *
     * @return self
     */
     ...
     * Sets place
     *
     * @param string|null $place Birth place.
     *
     * @return self
     */
