 ...
 */
class ContactIdentificationExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactIdentificationExtensions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('dateOfIssue', $data ?? [], null);
    ...
    */
     ...
     * Sets number
     *
     * @param string|null $number Id card number.
     *
     * @return self
     */
     ...
     * Sets authority
     *
     * @param string|null $authority Issuing authority of the identification card.
     *
     * @return self
     */
     ...
     * Sets dateOfIssue
     *
     * @param \DateTime|null $dateOfIssue Date on which the identification card was issued.
     *
     * @return self
     */
    public function setDateOfIssue($dateOfIssue)
    {
        if (is_null($dateOfIssue)) {
            throw new \InvalidArgumentException('non-nullable dateOfIssue cannot be null');
        }
     ...
     * Sets validTill
     *
     * @param \DateTime|null $validTill Date on which the validity of the identification card expires.
     *
     * @return self
     */
