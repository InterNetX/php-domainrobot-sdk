 ...
 */
class ContactRuExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactRuExtensions';
    ...
    protected static array $openAPINullables = [
        ...
        'territoryLinkedTaxpayerNumber' => false
    ];
    ...
    {
        $this->setIfExists('taxpayerIdentificationNumber', $data ?? [], null);
        $this->setIfExists('territoryLinkedTaxpayerNumber', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $taxpayerIdentificationNumber Taxpayer Identification Number (code). Mandatory for organisations which belong to the Russian Federation.
     *
     * @return self
     */
    public function setTaxpayerIdentificationNumber($taxpayerIdentificationNumber)
    {
        if (is_null($taxpayerIdentificationNumber)) {
            throw new \InvalidArgumentException('non-nullable taxpayerIdentificationNumber cannot be null');
        }
     ...
     *
     * @param string|null $territoryLinkedTaxpayerNumber Territory-linked Taxpayer Number (kpp). Mandatory for organisations which belong to the Russian Federation.
     *
     * @return self
     */
    public function setTerritoryLinkedTaxpayerNumber($territoryLinkedTaxpayerNumber)
    {
        if (is_null($territoryLinkedTaxpayerNumber)) {
            throw new \InvalidArgumentException('non-nullable territoryLinkedTaxpayerNumber cannot be null');
        }
