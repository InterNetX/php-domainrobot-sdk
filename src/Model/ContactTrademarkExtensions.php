...
class ContactTrademarkExtensions implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['regdate'] = isset($data['regdate']) ? $this->createData($data['regdate'], 'regdate')  : null;
        $this->container['appdate'] = isset($data['appdate']) ? $this->createData($data['appdate'], 'appdate')  : null;
        $this->container['office'] = isset($data['office']) ? $this->createData($data['office'], 'office')  : null;
    }
