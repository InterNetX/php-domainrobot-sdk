 ...
 */
class ContactXxxExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactXxxExtensions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('nonResolverDomain', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets membershipID
     *
     * @param string|null $membershipID Membership ID (token) for the .XXX community.   You receive your ID after you have finished the ICM registry membership process successfully and having created an account there.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $nonResolverDomain XXX community membership. Members have a membership ID (token).
     *
     * @return self
     */
    public function setNonResolverDomain($nonResolverDomain)
    {
        if (is_null($nonResolverDomain)) {
            throw new \InvalidArgumentException('non-nullable nonResolverDomain cannot be null');
        }
