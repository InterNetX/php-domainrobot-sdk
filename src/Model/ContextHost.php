 ...
 */
class ContextHost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContextHost';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('serverCert', $data ?? [], null);
        $this->setIfExists('caCert', $data ?? [], null);
    ...
    */
     ...
     * Sets master
     *
     * @param bool|null $master Show if host is default value
     *
     * @return self
     */
     ...
     * Sets csr
     *
     * @param string|null $csr The csr of the certificate
     *
     * @return self
     */
     ...
     * Sets serverCert
     *
     * @param string|null $serverCert The server certificate.
     *
     * @return self
     */
    public function setServerCert($serverCert)
    {
        if (is_null($serverCert)) {
            throw new \InvalidArgumentException('non-nullable serverCert cannot be null');
        }
     ...
     * Sets caCert
     *
     * @param string|null $caCert The intermediates of the certificate
     *
     * @return self
     */
    ...
    {
        if (is_null($caCert)) {
            throw new \InvalidArgumentException('non-nullable caCert cannot be null');
        }
     ...
     * Sets subStatus
     *
     * @param string|null $subStatus The job substatus
     *
     * @return self
     */
     ...
     * Gets zone
     *
     * @return \Domainrobot\Model\ContextHostZone|null
     */
     ...
     * Sets zone
     *
     * @param \Domainrobot\Model\ContextHostZone|null $zone zone
     *
     * @return self
     */
     ...
     * Gets certificate
     *
     * @return \Domainrobot\Model\BasicCertificate|null
     */
     ...
     * Sets certificate
     *
     * @param \Domainrobot\Model\BasicCertificate|null $certificate certificate
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The host name
     *
     * @return self
     */
