...
class CustomerContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('invoiceNotice', $data ?? [], null);
    ...
    */
     ...
     * Sets contract
     *
     * @param \Domainrobot\Model\GenericLabelEntity $contract contract
     *
     * @return self
     */
     ...
     * Gets accountManager
     *
     * @return \Domainrobot\Model\AccountManager|null
     */
     ...
     * Sets accountManager
     *
     * @param \Domainrobot\Model\AccountManager|null $accountManager accountManager
     *
     * @return self
     */
    public function setAccountManager($accountManager)
    {
        if (is_null($accountManager)) {
            throw new \InvalidArgumentException('non-nullable accountManager cannot be null');
        }
     ...
     * Sets invoiceNotice
     *
     * @param string|null $invoiceNotice The invoiceNotice.
     *
     * @return self
     */
    public function setInvoiceNotice($invoiceNotice)
    {
        if (is_null($invoiceNotice)) {
            throw new \InvalidArgumentException('non-nullable invoiceNotice cannot be null');
        }
     ...
     * Sets notice
     *
     * @param string|null $notice The notices.
     *
     * @return self
     */
