 ...
 */
class DomainCancelation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainCancelation';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('registryWhen', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($registryWhen)) {
            throw new \InvalidArgumentException('non-nullable registryWhen cannot be null');
        }
     ...
     *
     * @param string|null $gainingRegistrar The registrar to which the domain is to be transferred. Only possible with preack, for which it is required.   accept_all = All registrars are accepted   Designated registrar (e.g. DENIC-104). Ask the registry for the provider ID of your reseller. The transfer is then only possible to the selected registrar.
     *
     * @return self
     */
     ...
     * Sets disconnect
     *
     * @param bool|null $disconnect Specifies whether the domain is disconnected during a transit. Only possible with transit, for which it is necessary. Default value = false
     *
     * @return self
     */
     ...
     * Sets notice
     *
     * @param string|null $notice Some remarks
     *
     * @return self
     */
     ...
     * Sets logId
     *
     * @param int|null $logId Identifier specifically used for this transfer.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param \Domainrobot\Model\CancelationStatusConstants|null $status status
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \Domainrobot\Model\CancelationTypeConstants $type type
     *
     * @return self
     */
     ...
     * Sets execution
     *
     * @param \Domainrobot\Model\ExecutionTypeConstants $execution execution
     *
     * @return self
     */
