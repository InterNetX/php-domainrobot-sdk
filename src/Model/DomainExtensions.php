 ...
 */
class DomainExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainExtensions';
    ...
    protected static array $openAPINullables = [
        'domainBuyExtensions' => false,
        'domainAutodeleteExtensions' => false,
        'parkingExtensions' => false,
        'tmchClaimsNoticeExtensions' => false,
        'verificationExtensions' => false,
        'cancelationExtensions' => false
    ];
    ...
    {
        $this->setIfExists('domainBuyExtensions', $data ?? [], null);
        $this->setIfExists('domainAutodeleteExtensions', $data ?? [], null);
        $this->setIfExists('parkingExtensions', $data ?? [], null);
        $this->setIfExists('tmchClaimsNoticeExtensions', $data ?? [], null);
        $this->setIfExists('verificationExtensions', $data ?? [], null);
        $this->setIfExists('cancelationExtensions', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Domainrobot\Model\DomainBuyExtensions|null
     */
     ...
     *
     * @param \Domainrobot\Model\DomainBuyExtensions|null $domainBuyExtensions domainBuyExtensions
     *
     * @return self
     */
    public function setDomainBuyExtensions($domainBuyExtensions)
    {
        if (is_null($domainBuyExtensions)) {
            throw new \InvalidArgumentException('non-nullable domainBuyExtensions cannot be null');
        }
     ...
     *
     * @return \Domainrobot\Model\DomainAutodeleteExtensions|null
     */
     ...
     *
     * @param \Domainrobot\Model\DomainAutodeleteExtensions|null $domainAutodeleteExtensions domainAutodeleteExtensions
     *
     * @return self
     */
    public function setDomainAutodeleteExtensions($domainAutodeleteExtensions)
    {
        if (is_null($domainAutodeleteExtensions)) {
            throw new \InvalidArgumentException('non-nullable domainAutodeleteExtensions cannot be null');
        }
     ...
     *
     * @return \Domainrobot\Model\DomainParkingExtensions|null
     */
     ...
     *
     * @param \Domainrobot\Model\DomainParkingExtensions|null $parkingExtensions parkingExtensions
     *
     * @return self
     */
    public function setParkingExtensions($parkingExtensions)
    {
        if (is_null($parkingExtensions)) {
            throw new \InvalidArgumentException('non-nullable parkingExtensions cannot be null');
        }
     ...
     *
     * @return \Domainrobot\Model\DomainTmchClaimNoticeExtensions|null
     */
     ...
     *
     * @param \Domainrobot\Model\DomainTmchClaimNoticeExtensions|null $tmchClaimsNoticeExtensions tmchClaimsNoticeExtensions
     *
     * @return self
     */
    public function setTmchClaimsNoticeExtensions($tmchClaimsNoticeExtensions)
    {
        if (is_null($tmchClaimsNoticeExtensions)) {
            throw new \InvalidArgumentException('non-nullable tmchClaimsNoticeExtensions cannot be null');
        }
     ...
     *
     * @param \Domainrobot\Model\ContactVerificationDomain|null $verificationExtensions verificationExtensions
     *
     * @return self
     */
    public function setVerificationExtensions($verificationExtensions)
    {
        if (is_null($verificationExtensions)) {
            throw new \InvalidArgumentException('non-nullable verificationExtensions cannot be null');
        }
     ...
     *
     * @return \Domainrobot\Model\DomainCancelationExtensions|null
     */
     ...
     *
     * @param \Domainrobot\Model\DomainCancelationExtensions|null $cancelationExtensions cancelationExtensions
     *
     * @return self
     */
    public function setCancelationExtensions($cancelationExtensions)
    {
        if (is_null($cancelationExtensions)) {
            throw new \InvalidArgumentException('non-nullable cancelationExtensions cannot be null');
        }
