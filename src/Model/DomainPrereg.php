...
class DomainPrereg implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tmchMark'] = isset($data['tmchMark']) ? $data['tmchMark'] : null;
        $this->container['preregConfig'] = isset($data['preregConfig']) ? $data['preregConfig'] : null;
        ...
        $this->container['domainCreated'] = isset($data['domainCreated']) ? $data['domainCreated'] : null;
        $this->container['domainExpire'] = isset($data['domainExpire']) ? $data['domainExpire'] : null;
