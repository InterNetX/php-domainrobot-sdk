 ...
 */
class DomainServices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainServices';
    ...
    {
        $this->setIfExists('backupMx', $data ?? [], null);
        $this->setIfExists('mailProxy', $data ?? [], null);
        $this->setIfExists('redirect', $data ?? [], null);
        $this->setIfExists('domainMonitoring', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets backupMx
     *
     * @return \Domainrobot\Model\BackupMx[]|null
     */
     ...
     * Sets backupMx
     *
     * @param \Domainrobot\Model\BackupMx[]|null $backupMx Removes pending services like BackupMX and MailProxy.
     *
     * @return self
     */
    ...
    {
        if (is_null($backupMx)) {
            throw new \InvalidArgumentException('non-nullable backupMx cannot be null');
        }
     ...
     * Gets mailProxy
     *
     * @return \Domainrobot\Model\MailProxy[]|null
     */
     ...
     * Sets mailProxy
     *
     * @param \Domainrobot\Model\MailProxy[]|null $mailProxy Removes pending services like BackupMX and MailProxy.
     *
     * @return self
     */
    public function setMailProxy($mailProxy)
    {
        if (is_null($mailProxy)) {
            throw new \InvalidArgumentException('non-nullable mailProxy cannot be null');
        }
     ...
     * Gets redirect
     *
     * @return \Domainrobot\Model\Redirect[]|null
     */
     ...
     * Sets redirect
     *
     * @param \Domainrobot\Model\Redirect[]|null $redirect Removes pending services like BackupMX and MailProxy.
     *
     * @return self
     */
     ...
     *
     * @return \Domainrobot\Model\DomainMonitoring[]|null
     */
     ...
     *
     * @param \Domainrobot\Model\DomainMonitoring[]|null $domainMonitoring Removes pending services like BackupMX and MailProxy.
     *
     * @return self
     */
    public function setDomainMonitoring($domainMonitoring)
    {
        if (is_null($domainMonitoring)) {
            throw new \InvalidArgumentException('non-nullable domainMonitoring cannot be null');
        }
