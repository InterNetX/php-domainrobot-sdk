 ...
 */
class DomainServicesUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainServicesUpdate';
    ...
    */
     ...
     * Sets domains
     *
     * @param \Domainrobot\Model\Domain[]|null $domains The name of the domain.
     *
     * @return self
     */
