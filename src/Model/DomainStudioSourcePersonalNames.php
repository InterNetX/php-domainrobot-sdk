 ...
 */
class DomainStudioSourcePersonalNames implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainStudioSourcePersonalNames';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('spinFirstName', $data ?? [], null);
    ...
    */
     ...
     * Sets spinFirstName
     *
     * @param bool|null $spinFirstName Spin the first-name with relevant nicknames
     *
     * @return self
     */
    public function setSpinFirstName($spinFirstName)
    {
        if (is_null($spinFirstName)) {
            throw new \InvalidArgumentException('non-nullable spinFirstName cannot be null');
        }
