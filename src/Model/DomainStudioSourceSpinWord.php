 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomainStudioSourceSpinWord implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DomainStudioSourceSpinWord';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['similarity'] = isset($data['similarity']) ? $this->createData($data['similarity'], 'similarity')  : null;
        $this->container['position'] = isset($data['position']) ? $this->createData($data['position'], 'position')  : null;
    }
     ...
     * Sets similarity
     *
     * @param double $similarity Double with a value between 0.00 and 1.00.The higher this value, the closer thealternate word will be to the original word.
     *
     * @return $this
     */
     ...
     * Sets position
     *
     * @param int $position Position of the word for selective wordsuggestion starting with “0” for the firstword. If no position is supplied, allpositions are spinned.
     *
     * @return $this
     */
