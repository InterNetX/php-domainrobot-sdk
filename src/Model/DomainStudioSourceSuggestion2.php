 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomainStudioSourceSuggestion2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DomainStudioSourceSuggestion2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['maxSimilarWords'] = isset($data['maxSimilarWords']) ? $this->createData($data['maxSimilarWords'], 'maxSimilarWords')  : null;
        $this->container['maxPrefixSuffix'] = isset($data['maxPrefixSuffix']) ? $this->createData($data['maxPrefixSuffix'], 'maxPrefixSuffix')  : null;
        $this->container['useDash'] = isset($data['useDash']) ? $this->createData($data['useDash'], 'useDash')  : null;
        $this->container['useWordSegmentation'] = isset($data['useWordSegmentation']) ? $this->createData($data['useWordSegmentation'], 'useWordSegmentation')  : null;
     ...
     *
     * @param bool $useWordSegmentation Suggested domains with idn
     *
     * @return $this
     */
