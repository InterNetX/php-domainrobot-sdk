...
class EstimationParameters implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['averageLengthFrequency'] = isset($data['averageLengthFrequency']) ? $data['averageLengthFrequency'] : null;
        $this->container['averageLengthPrice'] = isset($data['averageLengthPrice']) ? $data['averageLengthPrice'] : null;
        ...
        $this->container['comDomain'] = isset($data['comDomain']) ? $data['comDomain'] : null;
        $this->container['completelyNum'] = isset($data['completelyNum']) ? $data['completelyNum'] : null;
        $this->container['foundKeywords'] = isset($data['foundKeywords']) ? $data['foundKeywords'] : null;
        $this->container['foundPrefix'] = isset($data['foundPrefix']) ? $data['foundPrefix'] : null;
        $this->container['foundSuffix'] = isset($data['foundSuffix']) ? $data['foundSuffix'] : null;
        $this->container['hyph'] = isset($data['hyph']) ? $data['hyph'] : null;
        $this->container['idnEncoding'] = isset($data['idnEncoding']) ? $data['idnEncoding'] : null;
        $this->container['keywordCount'] = isset($data['keywordCount']) ? $data['keywordCount'] : null;
        $this->container['majesticsGlobalRank'] = isset($data['majesticsGlobalRank']) ? $data['majesticsGlobalRank'] : null;
        $this->container['majesticsPrevGlobalRank'] = isset($data['majesticsPrevGlobalRank']) ? $data['majesticsPrevGlobalRank'] : null;
        $this->container['majesticsPrevRefIPs'] = isset($data['majesticsPrevRefIPs']) ? $data['majesticsPrevRefIPs'] : null;
        $this->container['majesticsPrevRefSubNets'] = isset($data['majesticsPrevRefSubNets']) ? $data['majesticsPrevRefSubNets'] : null;
        $this->container['majesticsPrevTldRank'] = isset($data['majesticsPrevTldRank']) ? $data['majesticsPrevTldRank'] : null;
        $this->container['majesticsRefIPs'] = isset($data['majesticsRefIPs']) ? $data['majesticsRefIPs'] : null;
        $this->container['majesticsRefSubNets'] = isset($data['majesticsRefSubNets']) ? $data['majesticsRefSubNets'] : null;
        $this->container['majesticsTldRank'] = isset($data['majesticsTldRank']) ? $data['majesticsTldRank'] : null;
        $this->container['nameSeg'] = isset($data['nameSeg']) ? $data['nameSeg'] : null;
