...
class EstimationParametersV1Language implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['en'] = isset($data['en']) ? $this->createData($data['en'], 'en')  : null;
        $this->container['de'] = isset($data['de']) ? $this->createData($data['de'], 'de')  : null;
        $this->container['fr'] = isset($data['fr']) ? $this->createData($data['fr'], 'fr')  : null;
