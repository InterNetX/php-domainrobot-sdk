...
class EstimationParametersV1NameBased implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['segements'] = isset($data['segements']) ? $data['segements'] : null;
        $this->container['keywords'] = isset($data['keywords']) ? $data['keywords'] : null;
        $this->container['numWords'] = isset($data['numWords']) ? $data['numWords'] : null;
        $this->container['isIDN'] = isset($data['isIDN']) ? $data['isIDN'] : null;
        $this->container['numDigits'] = isset($data['numDigits']) ? $data['numDigits'] : null;
        $this->container['numHyph'] = isset($data['numHyph']) ? $data['numHyph'] : null;
        $this->container['numChar'] = isset($data['numChar']) ? $data['numChar'] : null;
