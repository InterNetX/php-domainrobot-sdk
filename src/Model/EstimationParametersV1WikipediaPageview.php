<?php
/**
 * EstimationParametersV1WikipediaPageview
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EstimationParametersV1WikipediaPageview Class Doc Comment
 *
 * @category Class
 * @package  Domainrobot
 * @author   OpenAPI Generator team
 ...
 */
class EstimationParametersV1WikipediaPageview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EstimationParametersV1_wikipediaPageview';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('averagePageviewsPerDay', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $averagePageviewsPerDay averagePageviewsPerDay
     *
     * @return self
     */
    public function setAveragePageviewsPerDay($averagePageviewsPerDay)
    {
        if (is_null($averagePageviewsPerDay)) {
            throw new \InvalidArgumentException('non-nullable averagePageviewsPerDay cannot be null');
        }
