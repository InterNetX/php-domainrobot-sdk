 ...
 */
class EstimationV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EstimationV1';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('domainIdn', $data ?? [], null);
    ...
    */
     ...
     * Sets domainIdn
     *
     * @param string|null $domainIdn domainIdn
     *
     * @return self
     */
    public function setDomainIdn($domainIdn)
    {
        if (is_null($domainIdn)) {
            throw new \InvalidArgumentException('non-nullable domainIdn cannot be null');
        }
     ...
     * Sets estimation
     *
     * @param float|null $estimation estimation
     *
     * @return self
     */
     ...
     * Gets features
     *
     * @return \Domainrobot\Model\EstimationParametersV1|null
     */
     ...
     * Sets features
     *
     * @param \Domainrobot\Model\EstimationParametersV1|null $features features
     *
     * @return self
     */
