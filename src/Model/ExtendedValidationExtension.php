...
class ExtendedValidationExtension implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['joiCountryName'] = isset($data['joiCountryName']) ? $data['joiCountryName'] : null;
        $this->container['companyNumber'] = isset($data['companyNumber']) ? $data['companyNumber'] : null;
        $this->container['businessCategory'] = isset($data['businessCategory']) ? $data['businessCategory'] : null;
    }
