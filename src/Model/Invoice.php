...
class Invoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'subType' => false,
        'sepaMandateReference' => false,
        'sepaMandateCollection' => false,
        'amount' => false,
        'vatAmount' => false,
        'status' => false,
        'type' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('paymentTransaction', $data ?? [], null);
        $this->setIfExists('subType', $data ?? [], null);
        $this->setIfExists('sepaMandateReference', $data ?? [], null);
        $this->setIfExists('sepaMandateCollection', $data ?? [], null);
    ...
    */
     ...
     * Gets payment
     *
     * @return \Domainrobot\Model\PaymentConstants|null
     */
     ...
     * Sets payment
     *
     * @param \Domainrobot\Model\PaymentConstants|null $payment payment
     *
     * @return self
     */
     ...
     * Sets paymentMode
     *
     * @param string|null $paymentMode Additional payment data, such as provider: ipayment
     *
     * @return self
     */
     ...
     *
     * @param string|null $paymentTransaction The payment transaction number
     *
     * @return self
     */
    public function setPaymentTransaction($paymentTransaction)
    {
        if (is_null($paymentTransaction)) {
            throw new \InvalidArgumentException('non-nullable paymentTransaction cannot be null');
        }
     ...
     * Sets subType
     *
     * @param string|null $subType The sub type of the invoice, e.g. domain invoice or server invoice
     *
     * @return self
     */
     ...
     *
     * @param string|null $sepaMandateReference SEPA Mandate Reference
     *
     * @return self
     */
    public function setSepaMandateReference($sepaMandateReference)
    {
        if (is_null($sepaMandateReference)) {
            throw new \InvalidArgumentException('non-nullable sepaMandateReference cannot be null');
        }
     ...
     *
     * @param \DateTime|null $sepaMandateCollection Date of SEPA collection
     *
     * @return self
     */
    public function setSepaMandateCollection($sepaMandateCollection)
    {
        if (is_null($sepaMandateCollection)) {
            throw new \InvalidArgumentException('non-nullable sepaMandateCollection cannot be null');
        }
     ...
     * Gets status
     *
     * @return \Domainrobot\Model\InvoiceStatusConstants|null
     */
     ...
     * Sets status
     *
     * @param \Domainrobot\Model\InvoiceStatusConstants|null $status status
     *
     * @return self
     */
     ...
     * Sets failed
     *
     * @param bool|null $failed Indicator that shows that something is wrong with the process
     *
     * @return self
     */
     ...
     * Sets paid
     *
     * @param \DateTime|null $paid Date of payment
     *
     * @return self
     */
     ...
     * Sets extension
     *
     * @param object|null $extension extension
     *
     * @return self
     */
