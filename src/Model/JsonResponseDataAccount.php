 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataAccount';
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\Account[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
