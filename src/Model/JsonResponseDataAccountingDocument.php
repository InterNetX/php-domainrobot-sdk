<?php
/**
 * JsonResponseDataAccountingDocument
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * JsonResponseDataAccountingDocument Class Doc Comment
 *
 * @category Class
 * @package  Domainrobot
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataAccountingDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataAccountingDocument';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\AccountingDocument[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\AccountingDocument[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\AccountingDocument[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
