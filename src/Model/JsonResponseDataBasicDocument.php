...
class JsonResponseDataBasicDocument implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\BasicDocument[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\BasicDocument[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
