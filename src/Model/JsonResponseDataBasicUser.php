 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataBasicUser implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataBasicUser';
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\BasicUser[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
