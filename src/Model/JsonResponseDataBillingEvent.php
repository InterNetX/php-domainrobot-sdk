...
/**
 * JsonResponseDataBillingEvent Class Doc Comment
 *
 * @category Class
 * @package  Domainrobot
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataBillingEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataBillingEvent';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\BillingEvent[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\BillingEvent[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\BillingEvent[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
