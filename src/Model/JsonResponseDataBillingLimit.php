 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataBillingLimit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataBillingLimit';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\BillingLimit[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\BillingLimit[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
