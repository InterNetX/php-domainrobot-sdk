 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataBillingObjectTerms implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataBillingObjectTerms';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\BillingObjectTerms[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\BillingObjectTerms[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
