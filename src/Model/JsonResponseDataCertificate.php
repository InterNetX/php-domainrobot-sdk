...
class JsonResponseDataCertificate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\Certificate[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\Certificate[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\Certificate[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
