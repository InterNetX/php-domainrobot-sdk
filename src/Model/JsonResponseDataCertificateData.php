...
class JsonResponseDataCertificateData implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\CertificateData[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\CertificateData[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\CertificateData[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
