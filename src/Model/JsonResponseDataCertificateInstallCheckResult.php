 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataCertificateInstallCheckResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataCertificateInstallCheckResult';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\CertificateInstallCheckResult[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\CertificateInstallCheckResult[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
