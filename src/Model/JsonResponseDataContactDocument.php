 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataContactDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataContactDocument';
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\ContactDocument[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
