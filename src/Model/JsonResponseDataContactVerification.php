 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataContactVerification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataContactVerification';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\ContactVerification[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\ContactVerification[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
