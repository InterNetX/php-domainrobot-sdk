...
class JsonResponseDataDomainEnvelope implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\DomainEnvelope[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\DomainEnvelope[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\DomainEnvelope[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
