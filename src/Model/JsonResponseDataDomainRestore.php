...
class JsonResponseDataDomainRestore implements ModelInterface, ArrayAccess
{
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\DomainRestore[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\DomainRestore[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
