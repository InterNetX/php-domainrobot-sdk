...
class JsonResponseDataDomainRestore implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\DomainRestore[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\DomainRestore[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\DomainRestore[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
