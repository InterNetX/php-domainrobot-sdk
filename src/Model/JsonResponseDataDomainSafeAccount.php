 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataDomainSafeAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataDomainSafeAccount';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\DomainSafeAccount[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\DomainSafeAccount[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
