 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataDomainSafeObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataDomainSafeObject';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\DomainSafeObject[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\DomainSafeObject[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
