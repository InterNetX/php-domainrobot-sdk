...
class JsonResponseDataHandleVerification implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\HandleVerification[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\HandleVerification[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\HandleVerification[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
