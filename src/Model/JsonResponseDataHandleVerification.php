...
class JsonResponseDataHandleVerification implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\HandleVerification[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\HandleVerification[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\HandleVerification[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
