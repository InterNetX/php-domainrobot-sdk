...
class JsonResponseDataId4meIdentity implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\Id4meIdentity[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\Id4meIdentity[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\Id4meIdentity[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
