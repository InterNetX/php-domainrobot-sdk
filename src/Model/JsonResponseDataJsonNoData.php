...
class JsonResponseDataJsonNoData implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\JsonNoData[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\JsonNoData[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\JsonNoData[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
