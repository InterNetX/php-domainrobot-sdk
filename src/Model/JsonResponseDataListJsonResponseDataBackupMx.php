...
class JsonResponseDataListJsonResponseDataBackupMx implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\JsonResponseDataBackupMx[][]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\JsonResponseDataBackupMx[][]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\JsonResponseDataBackupMx[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
