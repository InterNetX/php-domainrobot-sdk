<?php
/**
 * JsonResponseDataListJsonResponseDataBillingEvent
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * JsonResponseDataListJsonResponseDataBillingEvent Class Doc Comment
 *
 * @category Class
 * @package  Domainrobot
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataListJsonResponseDataBillingEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataListJsonResponseDataBillingEvent';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\JsonResponseDataBillingEvent[][]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\JsonResponseDataBillingEvent[][]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\JsonResponseDataBillingEvent[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
