...
class JsonResponseDataListJsonResponseDataDomain implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\JsonResponseDataDomain[][]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\JsonResponseDataDomain[][]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\JsonResponseDataDomain[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
