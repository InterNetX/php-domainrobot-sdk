...
class JsonResponseDataListJsonResponseDataDomainCancelation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\JsonResponseDataDomainCancelation[][]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\JsonResponseDataDomainCancelation[][]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\JsonResponseDataDomainCancelation[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
