 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataListJsonResponseDataDomainPrereg implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataListJsonResponseDataDomainPrereg';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\JsonResponseDataDomainPrereg[][]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\JsonResponseDataDomainPrereg[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
