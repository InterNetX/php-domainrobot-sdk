 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataListJsonResponseDataParkingDomain implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataListJsonResponseDataParkingDomain';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\JsonResponseDataParkingDomain[][]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\JsonResponseDataParkingDomain[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
