 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataListJsonResponseDataPrice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataListJsonResponseDataPrice';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\JsonResponseDataPrice[][]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\JsonResponseDataPrice[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
