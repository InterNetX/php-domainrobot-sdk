 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataListJsonResponseDataSslContact implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataListJsonResponseDataSslContact';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\JsonResponseDataSslContact[][]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\JsonResponseDataSslContact[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
