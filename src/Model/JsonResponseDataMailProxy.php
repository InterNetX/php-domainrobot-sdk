...
class JsonResponseDataMailProxy implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\MailProxy[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\MailProxy[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
