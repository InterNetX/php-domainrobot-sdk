...
class JsonResponseDataOTPAuth implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\OTPAuth[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\OTPAuth[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\OTPAuth[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
