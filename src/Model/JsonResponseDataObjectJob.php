...
class JsonResponseDataObjectJob implements ModelInterface, ArrayAccess
{
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\ObjectJob[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\ObjectJob[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
