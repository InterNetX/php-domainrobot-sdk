...
class JsonResponseDataObjectJob implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\IXDomainRobot\Model\ObjectJob[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\ObjectJob[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\ObjectJob[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
