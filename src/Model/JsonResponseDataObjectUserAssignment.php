 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataObjectUserAssignment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataObjectUserAssignment';
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\ObjectUserAssignment[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
