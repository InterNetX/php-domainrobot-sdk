 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataParkingDomain implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataParkingDomain';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\ParkingDomain[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\ParkingDomain[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
