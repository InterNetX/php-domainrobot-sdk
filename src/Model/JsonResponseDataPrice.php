 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataPrice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataPrice';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\Price[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\Price[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
