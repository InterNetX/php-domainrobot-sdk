 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataServiceUsersProfile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataServiceUsersProfile';
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\ServiceUsersProfile[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
