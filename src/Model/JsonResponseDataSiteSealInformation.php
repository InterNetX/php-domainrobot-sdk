 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataSiteSealInformation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataSiteSealInformation';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\SiteSealInformation[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\SiteSealInformation[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
