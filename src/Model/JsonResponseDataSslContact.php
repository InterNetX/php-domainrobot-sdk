...
class JsonResponseDataSslContact implements ModelInterface, ArrayAccess
{
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\SslContact[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
