 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataTaskUserLimit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataTaskUserLimit';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\TaskUserLimit[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\TaskUserLimit[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
