 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataTldProduct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataTldProduct';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\TldProduct[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\TldProduct[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
