 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataTmchClaimsNotice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataTmchClaimsNotice';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\TmchClaimsNotice[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\TmchClaimsNotice[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
