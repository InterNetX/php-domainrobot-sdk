 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataTmchMark implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataTmchMark';
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\TmchMark[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
