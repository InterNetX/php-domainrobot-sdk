...
class JsonResponseDataTransferOut implements ModelInterface, ArrayAccess
{
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\TransferOut[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\TransferOut[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
