...
class JsonResponseDataTrustedApplication implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\TrustedApplication[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\TrustedApplication[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
