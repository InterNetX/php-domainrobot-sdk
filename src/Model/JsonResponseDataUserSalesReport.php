 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataUserSalesReport implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataUserSalesReport';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\UserSalesReport[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\UserSalesReport[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
