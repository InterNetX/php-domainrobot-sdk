 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataVmcCheckData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataVmcCheckData';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\VmcCheckData[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\VmcCheckData[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
