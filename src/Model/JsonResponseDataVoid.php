...
class JsonResponseDataVoid implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Domainrobot\Model\VoidResponse[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\VoidResponse[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\VoidResponse[] $data The data for the response. The type of the objects are depending on the request and are also specified in the ResponseObject value of the response.
     *
     * @return $this
     */
