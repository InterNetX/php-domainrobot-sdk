...
class JsonResponseDataVoid implements ModelInterface, ArrayAccess
{
     ...
     * Gets data
     *
     * @return \IXDomainRobot\Model\Void[]
     */
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\Void[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
