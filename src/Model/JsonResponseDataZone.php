...
class JsonResponseDataZone implements ModelInterface, ArrayAccess
{
     ...
     * Sets data
     *
     * @param \IXDomainRobot\Model\Zone[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
