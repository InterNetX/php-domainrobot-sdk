 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataZoneQuery implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataZoneQuery';
     ...
     * Gets data
     *
     * @return \Domainrobot\Model\ZoneQuery[]
     */
     ...
     * Sets data
     *
     * @param \Domainrobot\Model\ZoneQuery[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
