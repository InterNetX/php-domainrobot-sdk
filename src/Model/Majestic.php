...
class Majestic implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['itemNu'] = isset($data['itemNu']) ? $data['itemNu'] : null;
        $this->container['item'] = isset($data['item']) ? $data['item'] : null;
        $this->container['resultCode'] = isset($data['resultCode']) ? $data['resultCode'] : null;
        $this->container['status'] = isset($data['status']) ? $data['status'] : null;
        $this->container['extBackLinks'] = isset($data['extBackLinks']) ? $data['extBackLinks'] : null;
        $this->container['refDomains'] = isset($data['refDomains']) ? $data['refDomains'] : null;
        $this->container['analysisResUnitsCost'] = isset($data['analysisResUnitsCost']) ? $data['analysisResUnitsCost'] : null;
        $this->container['aCRank'] = isset($data['aCRank']) ? $data['aCRank'] : null;
        $this->container['itemType'] = isset($data['itemType']) ? $data['itemType'] : null;
        $this->container['indexedURLs'] = isset($data['indexedURLs']) ? $data['indexedURLs'] : null;
        $this->container['getTopBackLinksAnalysisResUnitsCost'] = isset($data['getTopBackLinksAnalysisResUnitsCost']) ? $data['getTopBackLinksAnalysisResUnitsCost'] : null;
        $this->container['downloadBacklinksAnalysisResUnitsCost'] = isset($data['downloadBacklinksAnalysisResUnitsCost']) ? $data['downloadBacklinksAnalysisResUnitsCost'] : null;
        $this->container['downloadRefDomainBacklinksAnalysisResUnitsCost'] = isset($data['downloadRefDomainBacklinksAnalysisResUnitsCost']) ? $data['downloadRefDomainBacklinksAnalysisResUnitsCost'] : null;
        ...
        $this->container['refDomainsEDU'] = isset($data['refDomainsEDU']) ? $data['refDomainsEDU'] : null;
        $this->container['extBackLinksEDU'] = isset($data['extBackLinksEDU']) ? $data['extBackLinksEDU'] : null;
        $this->container['refDomainsGOV'] = isset($data['refDomainsGOV']) ? $data['refDomainsGOV'] : null;
        $this->container['extBackLinksGOV'] = isset($data['extBackLinksGOV']) ? $data['extBackLinksGOV'] : null;
        $this->container['refDomainsEDUExact'] = isset($data['refDomainsEDUExact']) ? $data['refDomainsEDUExact'] : null;
        $this->container['extBackLinksEDUExact'] = isset($data['extBackLinksEDUExact']) ? $data['extBackLinksEDUExact'] : null;
        $this->container['refDomainsGOVExact'] = isset($data['refDomainsGOVExact']) ? $data['refDomainsGOVExact'] : null;
        $this->container['extBackLinksGOVExact'] = isset($data['extBackLinksGOVExact']) ? $data['extBackLinksGOVExact'] : null;
        $this->container['crawledFlag'] = isset($data['crawledFlag']) ? $data['crawledFlag'] : null;
        $this->container['lastCrawlDate'] = isset($data['lastCrawlDate']) ? $data['lastCrawlDate'] : null;
        $this->container['lastCrawlResult'] = isset($data['lastCrawlResult']) ? $data['lastCrawlResult'] : null;
        $this->container['redirectFlag'] = isset($data['redirectFlag']) ? $data['redirectFlag'] : null;
        $this->container['finalRedirectResult'] = isset($data['finalRedirectResult']) ? $data['finalRedirectResult'] : null;
        $this->container['outDomainsExternal'] = isset($data['outDomainsExternal']) ? $data['outDomainsExternal'] : null;
        $this->container['outLinksExternal'] = isset($data['outLinksExternal']) ? $data['outLinksExternal'] : null;
        $this->container['outLinksInternal'] = isset($data['outLinksInternal']) ? $data['outLinksInternal'] : null;
        $this->container['outLinksPages'] = isset($data['outLinksPages']) ? $data['outLinksPages'] : null;
        ...
        $this->container['languageConfidence'] = isset($data['languageConfidence']) ? $data['languageConfidence'] : null;
        $this->container['languagePageRatios'] = isset($data['languagePageRatios']) ? $data['languagePageRatios'] : null;
        $this->container['languageTotalPages'] = isset($data['languageTotalPages']) ? $data['languageTotalPages'] : null;
        $this->container['refLanguage'] = isset($data['refLanguage']) ? $data['refLanguage'] : null;
        $this->container['refLanguageDesc'] = isset($data['refLanguageDesc']) ? $data['refLanguageDesc'] : null;
        $this->container['refLanguageConfidence'] = isset($data['refLanguageConfidence']) ? $data['refLanguageConfidence'] : null;
        $this->container['refLanguagePageRatios'] = isset($data['refLanguagePageRatios']) ? $data['refLanguagePageRatios'] : null;
        $this->container['refLanguageTotalPages'] = isset($data['refLanguageTotalPages']) ? $data['refLanguageTotalPages'] : null;
        $this->container['crawledURLs'] = isset($data['crawledURLs']) ? $data['crawledURLs'] : null;
        $this->container['rootDomainIPAddress'] = isset($data['rootDomainIPAddress']) ? $data['rootDomainIPAddress'] : null;
        $this->container['totalNonUniqueLinks'] = isset($data['totalNonUniqueLinks']) ? $data['totalNonUniqueLinks'] : null;
        $this->container['nonUniqueLinkTypeHomepages'] = isset($data['nonUniqueLinkTypeHomepages']) ? $data['nonUniqueLinkTypeHomepages'] : null;
        $this->container['nonUniqueLinkTypeIndirect'] = isset($data['nonUniqueLinkTypeIndirect']) ? $data['nonUniqueLinkTypeIndirect'] : null;
        $this->container['nonUniqueLinkTypeDeleted'] = isset($data['nonUniqueLinkTypeDeleted']) ? $data['nonUniqueLinkTypeDeleted'] : null;
        $this->container['nonUniqueLinkTypeNoFollow'] = isset($data['nonUniqueLinkTypeNoFollow']) ? $data['nonUniqueLinkTypeNoFollow'] : null;
        $this->container['nonUniqueLinkTypeProtocolHTTPS'] = isset($data['nonUniqueLinkTypeProtocolHTTPS']) ? $data['nonUniqueLinkTypeProtocolHTTPS'] : null;
        $this->container['nonUniqueLinkTypeFrame'] = isset($data['nonUniqueLinkTypeFrame']) ? $data['nonUniqueLinkTypeFrame'] : null;
        $this->container['nonUniqueLinkTypeImageLink'] = isset($data['nonUniqueLinkTypeImageLink']) ? $data['nonUniqueLinkTypeImageLink'] : null;
        $this->container['nonUniqueLinkTypeRedirect'] = isset($data['nonUniqueLinkTypeRedirect']) ? $data['nonUniqueLinkTypeRedirect'] : null;
        $this->container['nonUniqueLinkTypeTextLink'] = isset($data['nonUniqueLinkTypeTextLink']) ? $data['nonUniqueLinkTypeTextLink'] : null;
        $this->container['refDomainTypeLive'] = isset($data['refDomainTypeLive']) ? $data['refDomainTypeLive'] : null;
        $this->container['refDomainTypeFollow'] = isset($data['refDomainTypeFollow']) ? $data['refDomainTypeFollow'] : null;
        $this->container['refDomainTypeHomepageLink'] = isset($data['refDomainTypeHomepageLink']) ? $data['refDomainTypeHomepageLink'] : null;
        $this->container['refDomainTypeDirect'] = isset($data['refDomainTypeDirect']) ? $data['refDomainTypeDirect'] : null;
        $this->container['refDomainTypeProtocolHTTPS'] = isset($data['refDomainTypeProtocolHTTPS']) ? $data['refDomainTypeProtocolHTTPS'] : null;
        $this->container['canonicalURL'] = isset($data['canonicalURL']) ? $data['canonicalURL'] : null;
        $this->container['citationFlow'] = isset($data['citationFlow']) ? $data['citationFlow'] : null;
        $this->container['trustFlow'] = isset($data['trustFlow']) ? $data['trustFlow'] : null;
        $this->container['trustMetric'] = isset($data['trustMetric']) ? $data['trustMetric'] : null;
        $this->container['topicalTrustFlowTopic0'] = isset($data['topicalTrustFlowTopic0']) ? $data['topicalTrustFlowTopic0'] : null;
        $this->container['topicalTrustFlowValue0'] = isset($data['topicalTrustFlowValue0']) ? $data['topicalTrustFlowValue0'] : null;
        $this->container['topicalTrustFlowTopic1'] = isset($data['topicalTrustFlowTopic1']) ? $data['topicalTrustFlowTopic1'] : null;
        $this->container['topicalTrustFlowValue1'] = isset($data['topicalTrustFlowValue1']) ? $data['topicalTrustFlowValue1'] : null;
        $this->container['topicalTrustFlowTopic2'] = isset($data['topicalTrustFlowTopic2']) ? $data['topicalTrustFlowTopic2'] : null;
        $this->container['topicalTrustFlowValue2'] = isset($data['topicalTrustFlowValue2']) ? $data['topicalTrustFlowValue2'] : null;
    }
