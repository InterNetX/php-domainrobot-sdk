...
class Modifier implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['search'] = isset($data['search']) ? $this->createData($data['search'], 'search')  : null;
        $this->container['replace'] = isset($data['replace']) ? $this->createData($data['replace'], 'replace')  : null;
