...
class NameServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ttl
     *
     * @param int|null $ttl Time-to-live value of the nameservers in seconds
     *
     * @return self
     */
     ...
     * Sets ipAddresses
     *
     * @param string[]|null $ipAddresses IPv4 and IPv6 addresses of the name server. For GLUE records only;  optional. The values for the IP addresses are only relevant for domain operations and are only used there in the case of glue name servers.
     *
     * @return self
     */
