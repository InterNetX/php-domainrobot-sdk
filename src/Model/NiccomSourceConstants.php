...
class NiccomSourceConstants
{
     ...
     */
    public const NIC_REQUEST = 'NIC_REQUEST';

    public const NIC_RESPONSE = 'NIC_RESPONSE';

    public const NIC_NOTIFY = 'NIC_NOTIFY';

    public const A3_REQUEST = 'A3_REQUEST';

    public const A3_RESPONSE = 'A3_RESPONSE';

    public const LOG_OBJECTS = 'LOG_OBJECTS';
