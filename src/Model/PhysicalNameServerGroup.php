 ...
 */
class PhysicalNameServerGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalNameServerGroup';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The custom label for the group
     *
     * @return self
     */
     ...
     * Sets articleLabel
     *
     * @param string|null $articleLabel The article label of the name server group, will be used for each created zone using these group
     *
     * @return self
     */
     ...
     * Gets supported
     *
     * @return \Domainrobot\Model\NameServerMode|null
     */
     ...
     * Sets supported
     *
     * @param \Domainrobot\Model\NameServerMode|null $supported supported
     *
     * @return self
     */
     ...
     * Sets dnssec
     *
     * @param bool|null $dnssec If the group supports dnssec
     *
     * @return self
     */
     ...
     * Sets statistic
     *
     * @param bool|null $statistic If the group contains statistical data for a zone
     *
     * @return self
     */
