...
class Recipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('attemptCount', $data ?? [], null);
    ...
    */
     ...
     * Gets role
     *
     * @return \Domainrobot\Model\RecipientRole|null
     */
     ...
     * Sets role
     *
     * @param \Domainrobot\Model\RecipientRole|null $role role
     *
     * @return self
     */
     ...
     * Sets attempt
     *
     * @param \DateTime|null $attempt The date of the next attempt
     *
     * @return self
     */
     ...
     * Sets attemptCount
     *
     * @param int|null $attemptCount The number of attempts
     *
     * @return self
     */
    public function setAttemptCount($attemptCount)
    {
        if (is_null($attemptCount)) {
            throw new \InvalidArgumentException('non-nullable attemptCount cannot be null');
        }
     ...
     * Sets expire
     *
     * @param \DateTime|null $expire The date after the mail delivery will be expire.
     *
     * @return self
     */
     ...
     * Gets logs
     *
     * @return \Domainrobot\Model\RecipientLog[]|null
     */
     ...
     * Sets logs
     *
     * @param \Domainrobot\Model\RecipientLog[]|null $logs The trace logs of each attempt
     *
     * @return self
     */
