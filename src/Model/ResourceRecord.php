 ...
 */
class ResourceRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceRecord';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pref', $data ?? [], null);
    ...
    */
     ...
     * Sets ttl
     *
     * @param int|null $ttl TTL of the record (Optionally if not set then Default SOA TTL is used)
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of the record, e.g. A
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The value of the record.
     *
     * @return self
     */
     ...
     * Sets pref
     *
     * @param int|null $pref Preference of the record, need for some record types e.g. MX
     *
     * @return self
     */
    ...
    {
        if (is_null($pref)) {
            throw new \InvalidArgumentException('non-nullable pref cannot be null');
        }
     ...
     * Sets raw
     *
     * @param string|null $raw The bind notation of the record. Only used by the zone stream task!
     *
     * @return self
     */
