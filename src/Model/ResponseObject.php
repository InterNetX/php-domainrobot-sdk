...
class ResponseObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseObject';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value The primary key of the object.
     *
     * @return self
     */
     ...
     * Sets summary
     *
     * @param int|null $summary The amound of objects found in list tasks.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object|null $data The value of the object.
     *
     * @return self
     */
