...
/**
 * ServiceProfiles Class Doc Comment
 *
 * @category Class
 * @package  Domainrobot
 * @author   OpenAPI Generator team
 ...
 */
class ServiceProfiles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceProfiles';
    ...
    */
     ...
     *
     * @param \Domainrobot\Model\ServiceUsersProfile[]|null $serviceProfiles The service profiles of the user.
     *
     * @return self
     */
