...
/**
 * SimilarDomain Class Doc Comment
 *
 * @category Class
 * @package  Domainrobot
 * @author   OpenAPI Generator team
 ...
 */
class SimilarDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimilarDomain';
    ...
    protected static array $openAPINullables = [
        'relatedDomainPrice' => false,
        'relatedDomains' => false
    ];
    ...
    {
        $this->setIfExists('relatedDomainPrice', $data ?? [], null);
        $this->setIfExists('relatedDomains', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param float|null $relatedDomainPrice relatedDomainPrice
     *
     * @return self
     */
    public function setRelatedDomainPrice($relatedDomainPrice)
    {
        if (is_null($relatedDomainPrice)) {
            throw new \InvalidArgumentException('non-nullable relatedDomainPrice cannot be null');
        }
     ...
     * Sets relatedDomains
     *
     * @param string|null $relatedDomains relatedDomains
     *
     * @return self
     */
    public function setRelatedDomains($relatedDomains)
    {
        if (is_null($relatedDomains)) {
            throw new \InvalidArgumentException('non-nullable relatedDomains cannot be null');
        }
