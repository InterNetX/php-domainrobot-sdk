 ...
 */
class Sistrix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sistrix';
    ...
    {
        $this->setIfExists('sichtbarkeitsindex', $data ?? [], null);
        $this->setIfExists('pages', $data ?? [], null);
        $this->setIfExists('kwcountSeo', $data ?? [], null);
        $this->setIfExists('kwcountSem', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $sichtbarkeitsindex sichtbarkeitsindex
     *
     * @return self
     */
    public function setSichtbarkeitsindex($sichtbarkeitsindex)
    {
        if (is_null($sichtbarkeitsindex)) {
            throw new \InvalidArgumentException('non-nullable sichtbarkeitsindex cannot be null');
        }
     ...
     * Sets kwcountSeo
     *
     * @param int|null $kwcountSeo kwcountSeo
     *
     * @return self
     */
    public function setKwcountSeo($kwcountSeo)
    {
        if (is_null($kwcountSeo)) {
            throw new \InvalidArgumentException('non-nullable kwcountSeo cannot be null');
        }
     ...
     * Sets kwcountSem
     *
     * @param int|null $kwcountSem kwcountSem
     *
     * @return self
     */
    public function setKwcountSem($kwcountSem)
    {
        if (is_null($kwcountSem)) {
            throw new \InvalidArgumentException('non-nullable kwcountSem cannot be null');
        }
