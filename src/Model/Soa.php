 ...
 */
class Soa implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Soa';
    ...
    */
     ...
     * Sets refresh
     *
     * @param int|null $refresh Number of seconds after which secondary name servers should query the master for the SOA record, to detect zone changes
     *
     * @return self
     */
     ...
     * Sets retry
     *
     * @param int|null $retry Number of seconds after which secondary name servers should retry to request the serial number from the master   if the master does not respond. It must be less than Refresh.
     *
     * @return self
     */
     ...
     * Sets expire
     *
     * @param int|null $expire Number of seconds after which secondary name servers   should stop answering request for this zone if the master does not respond.   This value must be bigger than the sum of Refresh and Retry.
     *
     * @return self
     */
     ...
     * Sets ttl
     *
     * @param int|null $ttl Time-to-live default value of the Resource Record of a zone
     *
     * @return self
     */
