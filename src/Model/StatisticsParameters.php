 ...
 */
class StatisticsParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatisticsParameters';
    ...
    {
        $this->setIfExists('totalQueries', $data ?? [], null);
        $this->setIfExists('webQueries', $data ?? [], null);
        $this->setIfExists('apiQueries', $data ?? [], null);
        $this->setIfExists('queryPercentage', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets totalQueries
     *
     * @param float|null $totalQueries totalQueries
     *
     * @return self
     */
    public function setTotalQueries($totalQueries)
    {
        if (is_null($totalQueries)) {
            throw new \InvalidArgumentException('non-nullable totalQueries cannot be null');
        }
     ...
     * Sets webQueries
     *
     * @param float|null $webQueries webQueries
     *
     * @return self
     */
    public function setWebQueries($webQueries)
    {
        if (is_null($webQueries)) {
            throw new \InvalidArgumentException('non-nullable webQueries cannot be null');
        }
     ...
     * Sets apiQueries
     *
     * @param float|null $apiQueries apiQueries
     *
     * @return self
     */
    public function setApiQueries($apiQueries)
    {
        if (is_null($apiQueries)) {
            throw new \InvalidArgumentException('non-nullable apiQueries cannot be null');
        }
     ...
     *
     * @param float|null $queryPercentage queryPercentage
     *
     * @return self
     */
    public function setQueryPercentage($queryPercentage)
    {
        if (is_null($queryPercentage)) {
            throw new \InvalidArgumentException('non-nullable queryPercentage cannot be null');
        }
