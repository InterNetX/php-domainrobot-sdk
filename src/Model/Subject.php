...
class Subject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the booking item, e.g. domain.de
     *
     * @return self
     */
     ...
     * Sets object
     *
     * @param string|null $object The internal unique name of the object, e.g. xn--
     *
     * @return self
     */
     ...
     * Sets customs
     *
     * @param \Domainrobot\Model\Custom[]|null $customs List of metadata
     *
     * @return self
     */
