 ...
 */
class SubjectAlternativeName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sslCertificateId', $data ?? [], null);
    ...
    */
     ...
     * Gets type
     *
     * @return \Domainrobot\Model\SanType|null
     */
     ...
     * Sets type
     *
     * @param \Domainrobot\Model\SanType|null $type type
     *
     * @return self
     */
     ...
     *
     * @param int|null $sslCertificateId Id of the certificate this SAN belongs to.
     *
     * @return self
     */
    public function setSslCertificateId($sslCertificateId)
    {
        if (is_null($sslCertificateId)) {
            throw new \InvalidArgumentException('non-nullable sslCertificateId cannot be null');
        }
     ...
     * Sets name
     *
     * @param string|null $name The name of the san.
     *
     * @return self
     */
     ...
     * Sets approverEmail
     *
     * @param string|null $approverEmail The approver email of the san.
     *
     * @return self
     */
     ...
     * Sets orderId
     *
     * @param string|null $orderId The order id of the san.
     *
     * @return self
     */
     ...
     * Sets free
     *
     * @param bool|null $free Defines whether the san was free or not
     *
     * @return self
     */
