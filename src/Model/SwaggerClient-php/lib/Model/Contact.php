...
class Contact implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'alias' => 'string',
        'type' => '\Swagger\Client\Model\ContactTypeConstants',
        'organization' => 'string',
        'title' => 'string',
        'city' => 'string',
        'country' => 'string',
        'state' => 'string',
        'email' => 'string',
        'protection' => '\Swagger\Client\Model\ContactProtectionConstants',
        'sip' => 'string',
        'remarks' => 'string[]',
        'domainsafe' => 'bool',
        'confirm_owner_consent' => 'bool',
        'comment' => 'string',
        'verification' => '\Swagger\Client\Model\GenericStatusConstants',
        'fname' => 'string',
        'lname' => 'string',
        'address' => 'string[]',
        'pcode' => 'string',
        'phone' => 'string',
        'fax' => 'string',
        'nic_ref' => '\Swagger\Client\Model\ContactReference[]',
        'extensions' => '\Swagger\Client\Model\ContactExtensions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['nic_ref'] = isset($data['nic_ref']) ? $data['nic_ref'] : null;
     ...
     * Gets type
     *
     * @return \Swagger\Client\Model\ContactTypeConstants
     */
     ...
     * Sets type
     *
     * @param \Swagger\Client\Model\ContactTypeConstants $type The type of the contact
     *
     * @return $this
     */
     ...
     * Gets protection
     *
     * @return \Swagger\Client\Model\ContactProtectionConstants
     */
     ...
     * Sets protection
     *
     * @param \Swagger\Client\Model\ContactProtectionConstants $protection The protection of the contact
     *
     * @return $this
     */
     ...
     * Gets verification
     *
     * @return \Swagger\Client\Model\GenericStatusConstants
     */
     ...
     * Sets verification
     *
     * @param \Swagger\Client\Model\GenericStatusConstants $verification The verification status of the contact
     *
     * @return $this
     */
     ...
     * Sets nic_ref
     *
     * @param \Swagger\Client\Model\ContactReference[] $nic_ref The nic references of the contact
     *
     * @return $this
     */
     ...
     * Gets extensions
     *
     * @return \Swagger\Client\Model\ContactExtensions
     */
     ...
     * Sets extensions
     *
     * @param \Swagger\Client\Model\ContactExtensions $extensions The contact extensions.
     *
     * @return $this
     */
