 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataBackupMx implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataBackupMx';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\BackupMx[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\BackupMx[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
