...
/**
 * JsonResponseDataBasicDocument Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataBasicDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataBasicDocument';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\BasicDocument[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\BasicDocument[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
