 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataCertificate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataCertificate';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\Certificate[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\Certificate[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\Certificate[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
