 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataDomainRestore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataDomainRestore';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\DomainRestore[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\DomainRestore[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\DomainRestore[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
