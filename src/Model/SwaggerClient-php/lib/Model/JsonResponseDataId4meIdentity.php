...
/**
 * JsonResponseDataId4meIdentity Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataId4meIdentity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataId4meIdentity';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\Id4meIdentity[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\Id4meIdentity[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\Id4meIdentity[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
