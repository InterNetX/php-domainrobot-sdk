 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataJsonNoData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataJsonNoData';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\JsonNoData[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\JsonNoData[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\JsonNoData[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
