...
class JsonResponseDataListJsonResponseDataDomainCancelation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\JsonResponseDataDomainCancelation[][]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\JsonResponseDataDomainCancelation[][]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\JsonResponseDataDomainCancelation[][] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
