 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataObjectJob implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataObjectJob';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\ObjectJob[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\ObjectJob[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\ObjectJob[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
