 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataPollMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataPollMessage';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\PollMessage[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\PollMessage[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\PollMessage[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
