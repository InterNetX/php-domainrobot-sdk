 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataSslContact implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataSslContact';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\SslContact[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\SslContact[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
