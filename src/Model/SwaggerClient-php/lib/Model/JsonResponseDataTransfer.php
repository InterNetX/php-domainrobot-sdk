 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataTransfer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataTransfer';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\Transfer[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\Transfer[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
