 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataVoid implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataVoid';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\Void[]',
        'ctid' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\Void[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\Void[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
