 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JsonResponseDataZone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JsonResponseDataZone';
    ...
    protected static $swaggerTypes = [
        ...
        'data' => '\Swagger\Client\Model\Zone[]',
        'ctid' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\Zone[] $data The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response.
     *
     * @return $this
     */
