...
class Modifier implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'search' => 'string',
        'replace' => 'string',
        'type' => '\Swagger\Client\Model\ModifierConstants'
    ];
     ...
     * Gets type
     *
     * @return \Swagger\Client\Model\ModifierConstants
     */
     ...
     * Sets type
     *
     * @param \Swagger\Client\Model\ModifierConstants $type The modifiers type, e.g. NAME_SERVER
     *
     * @return $this
     */
