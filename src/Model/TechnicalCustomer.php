 ...
 */
class TechnicalCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TechnicalCustomer';
    ...
    protected static array $openAPINullables = [
        ...
        'client' => false,
        'group' => false,
        'adoptExpiration' => false,
        'billingTerm' => false,
        'autoDeleteTlds' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('adoptExpiration', $data ?? [], null);
        $this->setIfExists('billingTerm', $data ?? [], null);
        $this->setIfExists('autoDeleteTlds', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Domainrobot\Model\AdoptExpiration|null
     */
     ...
     *
     * @param \Domainrobot\Model\AdoptExpiration|null $adoptExpiration adoptExpiration
     *
     * @return self
     */
    public function setAdoptExpiration($adoptExpiration)
    {
        if (is_null($adoptExpiration)) {
            throw new \InvalidArgumentException('non-nullable adoptExpiration cannot be null');
        }
     ...
     * Gets billingTerm
     *
     * @return \Domainrobot\Model\BillingTerm|null
     */
     ...
     * Sets billingTerm
     *
     * @param \Domainrobot\Model\BillingTerm|null $billingTerm billingTerm
     *
     * @return self
     */
    public function setBillingTerm($billingTerm)
    {
        if (is_null($billingTerm)) {
            throw new \InvalidArgumentException('non-nullable billingTerm cannot be null');
        }
     ...
     * Sets autoDeleteTlds
     *
     * @param string|null $autoDeleteTlds autoDeleteTlds
     *
     * @return self
     */
    public function setAutoDeleteTlds($autoDeleteTlds)
    {
        if (is_null($autoDeleteTlds)) {
            throw new \InvalidArgumentException('non-nullable autoDeleteTlds cannot be null');
        }
