 ...
 */
class TldPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TldPeriod';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cutoffPeriod', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets cutoffPeriod
     *
     * @param \Domainrobot\Model\TimePeriod|null $cutoffPeriod cutoffPeriod
     *
     * @return self
     */
    public function setCutoffPeriod($cutoffPeriod)
    {
        if (is_null($cutoffPeriod)) {
            throw new \InvalidArgumentException('non-nullable cutoffPeriod cannot be null');
        }
