...
class TmchMark implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['smdInclusion'] = isset($data['smdInclusion']) ? $data['smdInclusion'] : null;
        $this->container['claimsNotify'] = isset($data['claimsNotify']) ? $data['claimsNotify'] : null;
        $this->container['orderComplete'] = isset($data['orderComplete']) ? $data['orderComplete'] : null;
        $this->container['claimsNotifyExtended'] = isset($data['claimsNotifyExtended']) ? $data['claimsNotifyExtended'] : null;
        $this->container['extension'] = isset($data['extension']) ? $data['extension'] : null;
        $this->container['smdFile'] = isset($data['smdFile']) ? $data['smdFile'] : null;
    }
