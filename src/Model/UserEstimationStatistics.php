 ...
 */
class UserEstimationStatistics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserEstimationStatistics';
    ...
    protected static array $openAPINullables = [
        'queriesLast24Hours' => false,
        'queriesThisMonth' => false,
        'queriesThisYear' => false,
        'last12MonthsDevelopment' => false
    ];
    ...
    {
        $this->setIfExists('queriesLast24Hours', $data ?? [], null);
        $this->setIfExists('queriesThisMonth', $data ?? [], null);
        $this->setIfExists('queriesThisYear', $data ?? [], null);
        $this->setIfExists('last12MonthsDevelopment', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Domainrobot\Model\StatisticsParameters|null
     */
     ...
     *
     * @param \Domainrobot\Model\StatisticsParameters|null $queriesLast24Hours queriesLast24Hours
     *
     * @return self
     */
    public function setQueriesLast24Hours($queriesLast24Hours)
    {
        if (is_null($queriesLast24Hours)) {
            throw new \InvalidArgumentException('non-nullable queriesLast24Hours cannot be null');
        }
     ...
     *
     * @param \Domainrobot\Model\StatisticsParameters|null $queriesThisMonth queriesThisMonth
     *
     * @return self
     */
    public function setQueriesThisMonth($queriesThisMonth)
    {
        if (is_null($queriesThisMonth)) {
            throw new \InvalidArgumentException('non-nullable queriesThisMonth cannot be null');
        }
     ...
     *
     * @param \Domainrobot\Model\StatisticsParameters|null $queriesThisYear queriesThisYear
     *
     * @return self
     */
    public function setQueriesThisYear($queriesThisYear)
    {
        if (is_null($queriesThisYear)) {
            throw new \InvalidArgumentException('non-nullable queriesThisYear cannot be null');
        }
     ...
     *
     * @return \Domainrobot\Model\UserEstimationStatisticsLast12MonthsDevelopment|null
     */
     ...
     *
     * @param \Domainrobot\Model\UserEstimationStatisticsLast12MonthsDevelopment|null $last12MonthsDevelopment last12MonthsDevelopment
     *
     * @return self
     */
    public function setLast12MonthsDevelopment($last12MonthsDevelopment)
    {
        if (is_null($last12MonthsDevelopment)) {
            throw new \InvalidArgumentException('non-nullable last12MonthsDevelopment cannot be null');
        }
