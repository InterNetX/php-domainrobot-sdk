 ...
 */
class VirtualNameServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualNameServer';
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active Indicates whether the name server is in active use
     *
     * @return self
     */
     ...
     * Sets mainAddress
     *
     * @param object|null $mainAddress mainAddress
     *
     * @return self
     */
     ...
     * Sets ipAddresses
     *
     * @param string[]|null $ipAddresses IP addresses of the secondary name servers. Does not contain the primary IP address.
     *
     * @return self
     */
