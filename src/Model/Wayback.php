 ...
 */
class Wayback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Wayback';
    ...
    {
        $this->setIfExists('wayback', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets wayback
     *
     * @return \Domainrobot\Model\WaybackWayback|null
     */
     ...
     * Sets wayback
     *
     * @param \Domainrobot\Model\WaybackWayback|null $wayback wayback
     *
     * @return self
     */
    ...
    {
        if (is_null($wayback)) {
            throw new \InvalidArgumentException('non-nullable wayback cannot be null');
        }
