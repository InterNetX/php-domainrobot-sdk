 ...
 */
class WaybackWayback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Wayback_wayback';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('archivedSnapshots', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Domainrobot\Model\WaybackWaybackArchivedSnapshots|null
     */
     ...
     *
     * @param \Domainrobot\Model\WaybackWaybackArchivedSnapshots|null $archivedSnapshots archivedSnapshots
     *
     * @return self
     */
    public function setArchivedSnapshots($archivedSnapshots)
    {
        if (is_null($archivedSnapshots)) {
            throw new \InvalidArgumentException('non-nullable archivedSnapshots cannot be null');
        }
