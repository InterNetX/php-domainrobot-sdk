 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class X509CertificateIssuer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'X509CertificateIssuer';
     ...
     * Sets commonName
     *
     * @param string $commonName The CN attribute of the issuer
     *
     * @return $this
     */
     ...
     * Sets organization
     *
     * @param string $organization The O attribute of the issuer
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string $country The C attribute of the issuer
     *
     * @return $this
     */
     ...
     *
     * @param string $organizationUnit The OU attribute of the issuer
     *
     * @return $this
     */
     ...
     * Sets locality
     *
     * @param string $locality The L attribute of the issuer
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state The ST attribute of the issuer
     *
     * @return $this
     */
