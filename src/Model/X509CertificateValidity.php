...
/**
 * X509CertificateValidity Class Doc Comment
 *
 * @category Class
 * @package  Domainrobot
 * @author   OpenAPI Generator team
 ...
 */
class X509CertificateValidity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'X509CertificateValidity';
    ...
    */
     ...
     * Sets notAfter
     *
     * @param \DateTime|null $notAfter The notAfter date of the certificate
     *
     * @return self
     */
     ...
     * Sets notBefore
     *
     * @param \DateTime|null $notBefore The notBefore date of the certificate
     *
     * @return self
     */
