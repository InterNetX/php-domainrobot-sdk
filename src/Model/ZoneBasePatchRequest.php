 ...
 */
class ZoneBasePatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZoneBasePatchRequest';
    ...
    protected static array $openAPINullables = [
        ...
        'roid' => false,
        'resourceRecordsAdd' => false,
        'resourceRecordsRem' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('zoneGrantsAdd', $data ?? [], null);
        $this->setIfExists('zoneGrantsRem', $data ?? [], null);
        ...
        $this->setIfExists('resourceRecordsAdd', $data ?? [], null);
        $this->setIfExists('resourceRecordsRem', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets zoneGrantsAdd
     *
     * @param string[]|null $zoneGrantsAdd Adds new zone garnts to the zone
     *
     * @return self
     */
    public function setZoneGrantsAdd($zoneGrantsAdd)
    {
        if (is_null($zoneGrantsAdd)) {
            throw new \InvalidArgumentException('non-nullable zoneGrantsAdd cannot be null');
        }
     ...
     * Sets zoneGrantsRem
     *
     * @param string[]|null $zoneGrantsRem Removes the zone garnts if exists.
     *
     * @return self
     */
    public function setZoneGrantsRem($zoneGrantsRem)
    {
        if (is_null($zoneGrantsRem)) {
            throw new \InvalidArgumentException('non-nullable zoneGrantsRem cannot be null');
        }
     ...
     * Gets modifiers
     *
     * @return \Domainrobot\Model\Modifier[]|null
     */
     ...
     * Sets modifiers
     *
     * @param \Domainrobot\Model\Modifier[]|null $modifiers The modifer to apply on the objects
     *
     * @return self
     */
    ...
    public function setResourceRecords($resourceRecords)
    {
        ...
        if ((count($resourceRecords) > 10000)) {
            throw new \InvalidArgumentException('invalid value for $resourceRecords when calling ZoneBasePatchRequest., number of items must be less than or equal to 10000.');
        }
        if ((count($resourceRecords) < 0)) {
            throw new \InvalidArgumentException('invalid length for $resourceRecords when calling ZoneBasePatchRequest., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @param \Domainrobot\Model\ResourceRecord[]|null $resourceRecordsAdd Adds new zone records to the extistings
     *
     * @return self
     */
    public function setResourceRecordsAdd($resourceRecordsAdd)
    {
        if (is_null($resourceRecordsAdd)) {
            throw new \InvalidArgumentException('non-nullable resourceRecordsAdd cannot be null');
        }
     ...
     *
     * @param \Domainrobot\Model\ResourceRecord[]|null $resourceRecordsRem Removes the zone records if exists.
     *
     * @return self
     */
    public function setResourceRecordsRem($resourceRecordsRem)
    {
        if (is_null($resourceRecordsRem)) {
            throw new \InvalidArgumentException('non-nullable resourceRecordsRem cannot be null');
        }
