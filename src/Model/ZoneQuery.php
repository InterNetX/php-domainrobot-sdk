 ...
 */
class ZoneQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZoneQuery';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('physicalHostname', $data ?? [], null);
    ...
    */
     ...
     * Sets unit
     *
     * @param \Domainrobot\Model\TimeUnitConstants|null $unit unit
     *
     * @return self
     */
     ...
     *
     * @param string|null $physicalHostname The physicalHostname by the system
     *
     * @return self
     */
    public function setPhysicalHostname($physicalHostname)
    {
        if (is_null($physicalHostname)) {
            throw new \InvalidArgumentException('non-nullable physicalHostname cannot be null');
        }
